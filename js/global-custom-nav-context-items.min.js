...
(function () {
  ...
  const globalCustomNav={cfg:{context_item:"",glbl:{nav_selector:"#menu",tray_portal:"#nav-tray-portal",tray_container:"navigation-tray-container",space:"tray-with-space-for-global-nav",menuItemClass:"ic-app-header__menu-list-item",trayActiveClass:"ic-app-header__menu-list-item--active"},rspv:{tray_portal:`span[dir="${document.querySelector("html").getAttribute("dir")??"ltr"}"] div[role="dialog"] ul`,tray_container:'div[class$="-tray__content"]'},targets:["_self","_blank","_parent","_top"]},load:t=>{if(document.querySelector(globalCustomNav.cfg.glbl.nav_selector)||document.querySelector(globalCustomNav.cfg.rspv.tray_portal)){if("undefined"!==document.querySelector(globalCustomNav.cfg.glbl.nav_selector)){globalCustomNav.dir=document.querySelector("html").getAttribute("dir")??"ltr",globalCustomNav.nav_items=Array.isArray(t.nav_items)?t.nav_items:t;var e=document.querySelector(`${globalCustomNav.cfg.glbl.nav_selector} li.${globalCustomNav.cfg.glbl.trayActiveClass} a`);e&&(globalCustomNav.cfg.context_item=e.id||e.closest("li").id),globalCustomNav.prepare_nav_items(globalCustomNav.nav_items,!1)}globalCustomNav.watch_glbl_tray(),globalCustomNav.watch_burger_tray()}},watch_burger_tray:(t,e)=>{const l=document.querySelector(globalCustomNav.cfg.rspv.tray_portal),a=document.querySelector("div.rspv-global-custom-nav");if(l)null==l||null==document.querySelector(".mobile-header-hamburger").offsetParent||a||(e.disconnect(),globalCustomNav.prepare_nav_items(globalCustomNav.nav_items,!0),document.querySelector(globalCustomNav.cfg.rspv.tray_container).classList.add("rspv-global-custom-nav"),globalCustomNav.exit_burger_tray());else if(void 0===e){new MutationObserver(globalCustomNav.watch_burger_tray).observe(document.body,{childList:!0,subtree:!0})}},exit_burger_tray:(t,e)=>{const l=document.querySelector(globalCustomNav.cfg.rspv.tray_portal);if(l){if(void 0===e){new MutationObserver(globalCustomNav.exit_burger_tray).observe(document.body,{childList:!0,subtree:!0})}}else l||(e.disconnect(),globalCustomNav.watch_burger_tray())},watch_glbl_tray:(t,e)=>{const l=document.querySelector(globalCustomNav.cfg.glbl.tray_portal);if(!l){if(void 0===e){new MutationObserver(globalCustomNav.watch_glbl_tray).observe(document.body,{childList:!0})}return}void 0!==e&&e.disconnect(),globalCustomNav.glbl_ensure_active_class(globalCustomNav.cfg.context_item);new MutationObserver(globalCustomNav.exit_glbl_tray).observe(l,{childList:!0,subtree:!0})},exit_glbl_tray:(t,e)=>{const l=document.querySelector(`${globalCustomNav.cfg.glbl.tray_portal} div.${globalCustomNav.cfg.glbl.tray_container}`);if(l){let t=[...l.classList].filter((t=>t.endsWith("-tray")))[0].replace("-tray","");if(globalCustomNav.glbl_ensure_active_class(`global_nav_${t}_link`),void 0===e){new MutationObserver(globalCustomNav.exit_glbl_tray).observe(document.body,{childList:!0})}}else l||(e.disconnect(),globalCustomNav.watch_glbl_tray())},glbl_ensure_active_class:t=>{t&&(Array.from(document.querySelectorAll(`${globalCustomNav.cfg.glbl.nav_selector} .${globalCustomNav.cfg.glbl.trayActiveClass}`)).forEach((t=>{t.classList.toggle(globalCustomNav.cfg.glbl.trayActiveClass)})),document.getElementById(t).closest("li").classList.add(globalCustomNav.cfg.glbl.trayActiveClass))},prepare_nav_items:(t,e=!0)=>{t.forEach((t=>{(void 0===t.roles||t.roles())&&(globalCustomNav.create_nav_icon(t,e),globalCustomNav.append_item(t,e),t.tray&&globalCustomNav.tray(t,e))}))},create_nav_icon:(t,e=!0)=>{t.tidle=t.title.replace(/[\W_]+/g,"")||Math.random().toString(18).slice(2),t.slug=`global_nav_${t.tidle}_link`;const l=1==ENV.K5_USER&&1==e?"Home":"Dashboard",a=e?`${globalCustomNav.cfg.rspv.tray_portal} svg[name="Icon${l}"]`:`#global_nav_${l.toLowerCase()}_link`,o=document.querySelector(a).closest("li").cloneNode(!0);o.setAttribute("id",(e?"rspv-":"")+`${t.slug}-item`),o.querySelector("svg").parentElement.classList.add((e?"rspv-":"")+`svg-${t.tidle}-holder`);const r=(e?"rspv-":"")+t.slug;o.querySelector("a").setAttribute("id",r),o.querySelector("a").href=t.href,void 0!==t.target&&globalCustomNav.cfg.targets.includes(t.target)&&o.querySelector("a").setAttribute("target",t.target),(o.querySelector(".menu-item__text")||o.querySelector('span[letter-spacing="normal"]')).textContent=t.title;const s=o.querySelector((e?".rspv-svg":".svg")+`-${t.tidle}-holder`);o.querySelector("svg").classList.remove("ic-icon-svg--dashboard","svg-icon-home");let c=[...o.querySelector("svg").classList];if(e||o.classList.remove(globalCustomNav.cfg.glbl.trayActiveClass),o.querySelector("svg").remove(),1==/^icon-[a-z]/.test(t.icon_svg)){let l=`<div id="${(e?"rspv-":"")+`${t.slug}-svg`}" role="presentation">`;l+=`<i class="icon-line ${t.icon_svg}${e?" gcn_inst_rspv_icon":""} gcn_inst_menu_icon"></i></div>`,s.insertAdjacentHTML("afterbegin",l)}else/^https/.test(t.icon_svg)?fetch(t.icon_svg,{mode:"cors",method:"GET",headers:{"Access-Control-Request-Method":"GET",Accept:"text/plain","Content-Type":"text/plain"}}).then((t=>t.text())).then((l=>{s.insertAdjacentHTML("afterbegin",l),o.querySelector("svg").setAttribute("id",(e?"rspv-":"")+`${t.slug}-svg`),o.querySelector("svg").classList.add(...c)})).catch(console.error.bind(console)):/^<svg/.test(t.icon_svg)&&(s.insertAdjacentHTML("afterbegin",t.icon_svg),o.querySelector("svg").setAttribute("id",(e?"rspv-":"")+`${t.slug}-svg`),o.querySelector("svg").classList.add(...c));t.icon=o},append_item:(t,e=!0)=>{const l=e?globalCustomNav.cfg.rspv.tray_portal:globalCustomNav.cfg.glbl.nav_selector,a=document.querySelector(`${l} li:last-child`),o=(1==e?globalCustomNav.cfg.rspv.tray_portal:globalCustomNav.cfg.glbl.nav_selector)+` > li:nth-of-type(${t.position})`;"number"==typeof t.position&&document.querySelector(o)?document.querySelector(o).after(t.icon):"after"==t.position?a.after(t.icon):a.before(t.icon);const r=new RegExp(`^${t.href}`);!e&&r.test(window.location.pathname)&&(globalCustomNav.cfg.context_item=t.slug,globalCustomNav.glbl_ensure_active_class(globalCustomNav.cfg.context_item))}};  
